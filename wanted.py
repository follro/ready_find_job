...
# DataFrame 선언 columns로 각 열의 이름 지정
...
# 공고 페이지 수  
for i in trange(20):    # for i in trange(pages): 를 통해 전체 페이지 탐색 가능. 모든공고는 시간이 오래걸려 일단 20페이지만 탐색
   ...
   # edu = soup.find_all('span','edu') # 학력 (오류에 의해 해결 될때까지 주석처리)
